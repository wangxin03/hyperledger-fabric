...
1、在kevin-marbles项目根目录下，新建app.js文件，代码如下：
...
2、在kevin-marbles项目根目录下，新建gulpfile.js文件，代码如下：
...
进入kevin-marbles/scripts目录，运行start.sh脚本启动网络
...
<img src="../../../../AppData/Roaming/Typora/typora-user-images/image-20200724171312982.png" alt="image-20200724171312982" style="zoom:50%;" />

**②安装、实例化链码**

在kevin-marbles/scripts目录下，安装、实例化链码：

```
node install_chaincode.js           //安装链码
node instantiate_chaincode.js       //实例化链码
```

安装链码成功：

<img src="../../../../AppData/Roaming/Typora/typora-user-images/image-20200724171753789.png" alt="image-20200724171753789" style="zoom:50%;" />

实例化链码成功：

<img src="../../../../AppData/Roaming/Typora/typora-user-images/image-20200724171924294.png" alt="image-20200724171924294" style="zoom:50%;" />

③启动应用

在kevin-marbles根目录启动应用：
...
<img src="../../../../AppData/Roaming/Typora/typora-user-images/image-20200724172148759.png" alt="image-20200724172148759" style="zoom:50%;" />
