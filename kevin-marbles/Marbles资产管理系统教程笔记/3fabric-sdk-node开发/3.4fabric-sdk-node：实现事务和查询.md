#### 3.4 fabric-sdk-node：实现事务和查询

需在utils / fc_wrangler / parts目录下创建high_availability.js，invoke_cc.js，query_cc.js，query_peer.js文件并编辑
...
**1、新建high_availability.js脚本**

在kevin-marbles/utils/fc_wrangler/parts目录，新建high_availability.js，代码如下：
