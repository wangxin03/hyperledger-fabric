...
1、在kevin-marbles根目录下，新建scripts目录用户存放脚本文件，并进入该目录
...
在kevin-marbles/scripts目录下，新建install_chaincode.js文件，其作用是安装链码

```
vim install_chaincode.js
```

install_chaincode.js代码如下：
...
在kevin-marbles/scripts目录下，新建instantiate_chaincode.js文件，其作用是实例化链码

```
vim instantiate_chaincode.js
```

instantiate_chaincode.js代码如下：
...
在kevin-marbles/scripts目录下，新建upgrade_chaincode.js文件，其作用是升级链码

```
vim upgrade_chaincode.js
```

upgrade_chaincode.js代码如下：
