...
在kevin-fabric-sdk-node/artifacts目录，新建network-config.yaml、network-config-aws.yaml、org1.yaml、org2.yaml文件配置基于sdk-node的fabric网络信息

1、在kevin-fabric-sdk-node/artifacts目录，新建network-config.yaml，代码如下：
...
2、在kevin-fabric-sdk-node/artifacts目录，新建network-config-aws.yaml，代码如下：
...
3、在kevin-fabric-sdk-node/artifacts目录，新建org1.yaml，代码如下：
...
4、在kevin-fabric-sdk-node/artifacts目录，新建org2.yaml，代码如下：
