...
1、在kevin-marbles/utils目录，新建misc.js文件，其作用是检查区块可靠性文件是否正确，并创建唯一ID串
...
2、1、在kevin-marbles/utils/connection_profile_lib目录，新建index.js文件，其作用是解析被封装在连接概要库中的文件的相关功能
